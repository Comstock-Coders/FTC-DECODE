package org.firstinspires.ftc.teamcode.comstockcoders.core.abstracts.state;

import java.util.ArrayList;
import org.firstinspires.ftc.comstockcoders.core.abstracts.action.Action;
import org.firstinspires.ftc.comstockcoders.core.abstracts.actuator.Actuator;
...
public abstract class State<S extends State<S>> {
  ...
  public boolean tryLock(Action<S> action) {
    // Ignore this, the lock is actually currently broken and doesn't do anything shhhhhhh
